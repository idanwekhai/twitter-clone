...
urlpatterns = [
    ...
    path('tweet/<int:pk>/delete', views.TweetDeleteView.as_view(), name='delete_tweet'),
    path('tweet/<int:pk>/like', views.TweetLikeView, name='like'),
    path('tweet/<int:pk>/unlike', views.TweetUnlikeView, name='unlike')
